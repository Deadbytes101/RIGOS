...
- `v0.0.1 — Observation Contract`: machine/XMRig inspection, typed JSON, zero mutation, canonical RIGOS namespace.
- `v0.0.2 — Local Authority`: explicit miner lifecycle, systemd ownership, crash recovery, thermal FSM, atomic policy revision and rollback.
...
Current preview: `0.0.4-alpha.20`. It is not an RC until all mandatory physical
